...
<script>
  ...
  if ($id != -1) {
      ...
      $stmt = $conn->prepare($sql);
      $stmt->bind_param("ssssssssssss", $_POST["datanascita"], strtoupper($_POST["codicefiscale"]), $_POST["residenza"], $_POST["indirizzo"], $_POST["cognome"], $_POST["nome"], $_POST["cellulare"], $_POST["email"], $_POST["telefono"], $_POST["cap"], $_POST["email"], $sex);
      $stmt->execute();
