...
if (!isset($_SESSION["varOrDIn"])) {
    $_SESSION["varOrDIn"] = 0;
}
if (!isset($_SESSION["varOrDFi"])) {
    $_SESSION["varOrDFi"] = 0;
}
//$_SESSION[varOrID'];

if (isset($_POST["esporta"])) {
    $sql = "select * from persona join persona_ruolo on id=idpersona and idruolo = 1";
...
<div class="container-fluid">
  <div class="row">
    ...
    function cerca($keyword)
    {
        ...
        $sql = 'SELECT * FROM persona join persona_ruolo on id=idpersona and idruolo = 1 WHERE';
	  ...
	  <div>
        ...
        if (isset($_POST["ordinaNome"])) {
            ...
            if ($_SESSION['varOrNome'] % 2 == 0) {
                $sql = "Select * from persona join persona_ruolo on id=idpersona and idruolo = 1 order by nome DESC";
            } else {
                $sql = "Select * from persona join persona_ruolo on id=idpersona and idruolo = 1 order by nome ASC";
            }
            $result = $conn->query($sql);
            ...
            if ($_SESSION['varOrCog'] % 2 == 0) {
                $sql = "Select * from persona join persona_ruolo on id=idpersona and idruolo = 1 order by cognome DESC";
                //$result = $conn->query($sql);
            } else {
                //$result = $db->cerca_docente_ordinato("cognome ASC");
                $sql = "Select * from persona join persona_ruolo on id=idpersona and idruolo = 1 order by cognome ASC";
            }
            $result = $conn->query($sql);
            generaTabella($result);
            ...
            if ($_SESSION['varOrCitta'] % 2 == 0) {
                $sql = "Select * from persona join persona_ruolo on id=idpersona and idruolo = 1 order by residenza DESC";
            } else {
                $sql = "Select * from persona join persona_ruolo on id=idpersona and idruolo = 1 order by residenza ASC";
            }
            $result = $conn->query($sql);
            generaTabella($result);
