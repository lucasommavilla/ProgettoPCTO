		...
		<div class="mb-4 clearfix">
                <div class="btn-toolbar float-start" role="toolbar" aria-label="Toolbar with button groups">
                  <div class="btn-group me-2" role="group" aria-label="First group">
                          <button type="button" onclick="location.href='index.php'" name="indietro" value="" class="btn btn-secondary">
                ...
                <input type="button" onclick="location.href='changepsw.php'" name="changepsw" value="Cambia Password" class="btn btn-outline-dark">
                    <input type="button" onclick="location.href='logout.php'" name="disconnetti" value="Disconnettiti" class="btn btn-danger">
                </div>
            </div>
		</div>
		<?php
